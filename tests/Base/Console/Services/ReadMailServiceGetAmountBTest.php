...
class ReadMailServiceGetAmountBTest extends TestCase
{
  ...
  protected function setUp(): void
  {
    ...
    $this->method = $reflection->getMethod('getAmountB');
  ...
  {
    $line = "CT125 ヘッドライトプロテクタークイックリリース付きステンレスブラック JP-CT-5095-0 14,300 円 1 14,301 円";
    $result = $this->method->invoke($this->service, $line);
    $expected = 14301;
