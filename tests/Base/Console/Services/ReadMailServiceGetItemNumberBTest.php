...
class ReadMailServiceGetItemNumberBTest extends TestCase
{
  ...
  protected function setUp(): void
  {
    ...
    $this->method = $reflection->getMethod('getItemNumberB');
