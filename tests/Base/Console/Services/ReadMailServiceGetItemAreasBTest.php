...
class ReadMailServiceGetItemAreasBTest extends TestCase
{
  ...
  protected function setUp(): void
  {
    ...
    $this->method = $reflection->getMethod('getItemAreasB');
...
以上";
    $result = $this->method->invoke($this->service, $body);
    $expected = "アドベンチャーフォールディングミラー（片側１本） M10x1.25 01-040-0771-0 5,093 円 2 10,186 円
CT125 ハンターカブ用ツールボックス JP-CT-5610-0 24,800 円 1 24,800 円
CT125 ヘッドライトプロテクタークイックリリース付きステンレスブラック JP-CT-5095-0 14,300 円 1 14,300 円
";
