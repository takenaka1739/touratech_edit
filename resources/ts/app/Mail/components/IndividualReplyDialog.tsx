...
type IndividualReplyDialogProps = {
...
type SearchDialogConditionsState = {
  c_keyword?: string;
  c_is_display: string;
 ...
 * @param props
 */
export const IndividualReplyDialog: React.VFC<IndividualReplyDialogProps> = ({
  onChangeState,
  isShown,
  isSetItem,
  onSelected,
  ...
  const {
    ...
    //onClickSelect,
    onClickCancel,
  } = useCommonSearchDialog<SearchDialogConditionsState, Item>(
    {
      c_keyword: '',
      c_is_display: '1',
