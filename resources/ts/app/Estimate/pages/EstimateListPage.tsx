...
import { useEstimateListPage } from '../uses/useEstimateListPage';
import { numberFormat } from '@/utils/numberFormat';
import { useComposing } from '@/uses';

/**
 * 見積データ（一覧）画面 Component
 */
export const EstimateListPage: React.VFC = () => {
  const title = '見積データ';
  const slug = 'estimate';
  const {
    isLoading,
