 ...
 * 受注データ共通フォームバリデーション
 */
trait ReceiveOrderRequestTrait
{
  public function commonRules()
  {
    return [
      ...
      'additional_shipping_amount' => 'nullable|numeric|price',
      ...
      'details.*.answer_date' => 'nullable|string',
    ];
  }
	...
	public function attributes()
	{
      ...
      'order_no' => '注文番号',
      'shipping_amount' => '送料',
      'additional_shipping_amount' => '別途追加送料',
      'fee' => '代引手数料',
      'discount' => '値引',
			'total_amount' => '合計金額',
			'remarks' => '備考',
